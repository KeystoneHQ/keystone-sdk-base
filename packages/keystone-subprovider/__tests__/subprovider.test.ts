            ...
            read: async (a, b) => {
                if(a[0] === "crypto-hdkey") {
                    ...
                    return {
                        status: 'success',
                        result: {
                            cbor: Buffer.from('a10258416d19ce88a3272c2d8cb8ca6a58bf1e72f63d4adc6163b25256b0f6a4e78410664c857185f395e590dfa7bc7a08fd675aa1127802f204eae7cdcfa6e1797840d025', 'hex')
                        }
                    }
                }
            },
